...
TEMPLATES: Dict[str, str] = {
    ...
    "IntegrationActionAgent": (
        ...
        "5. **The 6-Month Victory Path**: Build a highly detailed, incredibly valuable, life-changing roadmap covering EXACTLY 6 months, with EXACTLY 4 weeks per month. DO NOT SKIP ANY MONTHS.\n"
        ...
        "1. **Impact Statement**: A powerful, personalized summary of their situation.\n"
        ...
        "4. **Roadmap**: A 6-month plan covering ALL 6 months and ALL 4 weeks per month. **Crucial**: Use dynamic, inspiring month titles based on their specific goal.\n"
        ...
        "      ]\n"
        "    }\n"
        "    // ... REPEAT exactly this full structure for Month 2, Month 3, Month 4, Month 5, and Month 6! \n"
        "    // DO NOT output empty arrays! EVERY month must have 4 weeks. EVERY week must have 7 days!\n"
        "  ]\n"
        "}\n"
    ),
    "RecalibrationAgent": (
